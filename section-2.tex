...
When selected patch candidates $s_{i}$, \ldots, $s_{k}$ across a cover of $U$ are compatible, we say those patches glue together if there's a section $s$ in $F(U)$ that restricts down to exactly those patches.
