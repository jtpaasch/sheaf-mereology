...
A presentation provides the most ``minimal'' information from which the rest of the locale is generated. 
...
% ----------------------------------------
\begin{Definition}[Monopresheaves]
 
A presheaf $F$ is a monopresheaf iff it satisfies the following gluing-uniqueness condition:
...
Monopresheaves are also called separated presheaves. The ``mono'' part of the name comes from category theory: every joint restriction to a covering family is a monomorphism, i.e., there can be at most one section restricting to a given selection of patch candidates.
...
A monopresheaf $F$ is a sheaf iff it satisfies the following gluing-existence condition:
