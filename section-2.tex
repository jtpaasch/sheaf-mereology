...
Let $\category{L}$ be a topology or a locale, and let $U$ be a region of $\category{L}$. A \emph{cover} of $U$ is a family $\{ U_{i} \}_{i \in I} \subseteq \category{L}$ such that:
...
Given a presheaf $F$ and a cover $\{ U_{i} \}_{i \in I}$ with a corresponding family of fibers $\{ F(U_{i}) \}_{i \in I}$, a selection of \emph{patch candidates} $\{ s_{i} \}_{i \in I}$ is a choice of one section $s_{i}$ from each $F(U_{i})$.
